...
\usepackage{enumitem} % \begin{itemize}[leftmargin=*] to remove indents

% Переопределение стандартных \section, \subsection, \subsubsection по ГОСТу;

% BUG this ugly donkey breaks \addcontentsline references
% \usepackage{titlesec}
% \titleformat{\section}[block]
% {\bfseries\Large\filcenter}{\thesection}{1em}{}
...
\usepackage{etoolbox}
\patchcmd{\section}{\Large}{\centering\large}{}{}
